...
example : digest (t := Clap.Spec.Sha2.Cpu.t) (stringToU8s "abc") =
  #[0xba7816bf, 0x8f01cfea, 0x414140de, 0x5dae2223, 0xb00361a3, 0x96177a9c, 0xb410ff61, 0xf20015ad] := by
  native_decide

example : digest (t := Clap.Spec.Sha2.Cpu.t) (stringToU8s "abcdbcdecdefdefgefghfghighijhijkijkljklmklmnlmnomnopnopq") =
...
def testDigest (s : String) (expected : Array UInt32) : Option Unit := do
  ...
  let d := digest (t := Clap.Spec.Sha2.Circuit.t p) (stringToU8s s)
