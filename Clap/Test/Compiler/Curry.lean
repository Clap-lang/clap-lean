...
def Curry.ex₁ {p} [Core p] (p₁ : Vector (ZMod p) 2) (p₂ : Vector (ZMod p) 3) : Option Unit := do
  Spec.Compiler.eq0 (p₁[0] + p₂[2])
  Spec.Compiler.accept

/--
info: def - fun {p : ℕ} [Core p] (curried0_p₁ curried1_p₁ curried0_p₂ curried1_p₂ curried2_p₂ : ZMod Primes.babybear) => do
